...
import com.zhangyu.service.IJPABookService;
...
public class BookController {
    ...
    @Autowired
    private IJPABookService bookService;
    ...
    public String createBookForm(ModelMap modelMap) {
        log.info("跳转到列表...");
        modelMap.addAttribute("book", new JPABook());
    ...
    public String postBook(@ModelAttribute JPABook book) {
        log.info("添加书本到列表中...");
    ...
    public String putBook(@ModelAttribute JPABook book) {
        log.info("更新书本到列表中...");
        log.info(book);
